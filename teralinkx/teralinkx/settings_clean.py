...
# Pusher - development settings with defaults to prevent errors
PUSHER_APP_ID = os.environ.get('PUSHERID', 'dev-app-id')
PUSHER_KEY = os.environ.get('PUSHERKEY', 'dev-key')
PUSHER_SECRET = os.environ.get('PUSHERSCRT', 'dev-secret')
PUSHER_CLUSTER = os.environ.get('PUSHERCLT', 'us2')
