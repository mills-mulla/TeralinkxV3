...
import os
if not os.path.exists('/home/jovyan/datasets'):
    print("ERROR: Datasets not found. Run this in jupyter container.")
    exit(1)

train_df = pd.read_csv('/home/jovyan/datasets/KDDTrain+.txt', names=columns, nrows=20000)
...
print("\nBalancing...")
normal = X[y == 0].sample(min(10000, (y==0).sum()), random_state=42)
